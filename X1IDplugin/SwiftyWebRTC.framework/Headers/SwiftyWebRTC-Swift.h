...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwiftyWebRTC",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC12SwiftyWebRTC11RTCCapturer")
@interface RTCCapturer : NSObject
...
SWIFT_CLASS("_TtC12SwiftyWebRTC24RTCCapturerSettingsModel")
@interface RTCCapturerSettingsModel : NSObject
...
SWIFT_CLASS("_TtC12SwiftyWebRTC9RTCClient")
...
@interface RTCClient (SWIFT_EXTENSION(SwiftyWebRTC)) <RTCPeerConnectionDelegate>
